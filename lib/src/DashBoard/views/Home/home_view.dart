        ...
        children: [
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  image: DecorationImage(image: AssetImage(R.images.welcomeBG)),
                ),
              ),
              Positioned(
                top: 15,
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    heightBox(8),
                    Text(
                      "Explore courses, chat with instructors,and\ntrack progress in one place.",
          ...
          SizedBox(
            ...
            child: ListView.builder(
              ...
              itemCount: 3,
              itemBuilder: (context, index) => videoCard("Highlights Title","2:45"),
            ),
          ),

          // Recommended Courses
          buildTitle("Recommended Courses"),
          SizedBox(
            height: 170.h,
            child: ListView(
              scrollDirection: Axis.horizontal,
            ...
            child: Row(
              children: [
                Container(
                  ...
                  child: Text(
                    "Best Seller",
                    style: R.textStyles.poppins(color: Colors.white,fontSize: 11.sp,fontWeight: FontWeight.w600),
                  ),
                ),
                widthBox(5),
                Container(
